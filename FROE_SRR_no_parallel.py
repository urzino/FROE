...
class _Froe(object):
    def __init__(self, args): #init all parameters from terminal or default values
        ...
        self.nU = args.nu if args.nu != None else 3
        self.nY= args.ny if args.ny != None else 3
        self.polDegree = args.deg if args.deg != None else 1
        self.inclBias = args.incbias if args.incbias != None else False
        self.varianceToExplain1 = args.var1 if args.var1 != None else 0.40
        self.varianceToExplain2 = args.var2 if args.var2 != None else 0.93
        self.convergenceThresholdNARMAX = args.convth if args.convth != None else 0.1
    ...
    def froe(self, nU, nY, nE, U, Y, E, polDegree, yDim, inclBias, varianceToExplain1, varianceToExplain2, K, th, maxIt): #froe algorithm
        ...
        for j in tqdm(range(regDim)): #calculates err, g, updates a
            ...
            varianceExplained += -srr[bestRegressor] if (j == 0) else srr[bestRegressor]
