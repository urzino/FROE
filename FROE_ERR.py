...
class _Froe(object):
    def __init__(self, args): #init all parameters from terminal or default values
        ...
        self.nU = args.nu if args.nu != None else 8
        self.nY= args.ny if args.ny != None else 7
        self.polDegree = args.deg if args.deg != None else 3
        self.inclBias = args.incbias if args.incbias != None else True
        self.varianceToExplain1 = args.var1 if args.var1 != None else 0.996
        self.varianceToExplain2 = args.var2 if args.var2 != None else 0.9938
